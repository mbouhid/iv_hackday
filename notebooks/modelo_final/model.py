...
def export_file(X_test, predicao_xgb):
    # Concatena ID e variável alvo predita
    df_final = pd.concat([X_test.id, pd.Series(predicao_xgb, name = 'Reserva Cancelada')], axis=1)
...
if __name__ == "__main__":
    ...
    path_test = 'test.csv'
    X_train, y_train, X_test = get_data(path_train, path_test)
    ...
    export_file(X_test, predicao_xgb)